...
const App = () => {
  ...
  const finalCal = e => {
    ...
    const FirstFloor =
      UnitObj.FirstFloor.endUnit - UnitObj.FirstFloor.startUnit;
    const SecondFloor =
      UnitObj.SecondFloor.endUnit - UnitObj.SecondFloor.startUnit;
    const ThirdFloor =
      UnitObj.ThirdFloor.endUnit - UnitObj.ThirdFloor.startUnit;
  ...
  return (
    <div className="container">
      ...
      <div className="row MainMeter">
        <div className="col-2">Main Meter</div>
        <div className="col-2">
          <label for="inputPrefilledEx">Start Unit</label>
          <input
            name="mainstart"
            value={UnitObj.MainMeter.startUnit}
            onChange={e => enterUnitValue(e)}
            type="text"
            id="inputPrefilledEx1"
            className="form-control"
          />
        </div>
        <div className="col-2">
          <label for="inputPrefilledEx">End Unit</label>
          <input
            name="mainend"
            value={UnitObj.MainMeter.endUnit}
            onChange={e => enterUnitValue(e)}
            type="text"
            id="inputPrefilledEx2"
            className="form-control"
          />
        </div>
        <div className="col-2">
          {" "}
          Total Consumption Unit = <label>{FinalObj.MainMeter}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Unit Rate ({unitRs})
      ...
      <div className="row FirstMeter">
        <div className="col-2">First Floor</div>
        <div className="col-2">
          <label for="inputPrefilledEx">Start Unit</label>
          <input
            name="FS"
        ...
        <div className="col-2">
          {" "}
          Consumption Unit = <label f>{FinalObj.FirstFloor}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Correct Unit = <label f>{FinalObj.FUnit}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Amount = <label f>{FinalObj.FUnit * unitRs}</label>{" "}
        </div>
      </div>

      <div className="row SecondMeter">
        <div className="col-2">Second Floor</div>
        <div className="col-2">
          <label for="inputPrefilledEx">Start Unit</label>
          <input
            name="SS"
        ...
        <div className="col-2">
          ...
          <input
            name="SE"
            value={UnitObj.SecondFloor.endUnit}
            onChange={e => enterUnitValue(e)}
            type="text"
            id="inputPrefilledEx"
            className="form-control"
        ...
        <div className="col-2">
          {" "}
          Consumption Unit = <label f>{FinalObj.SecondFloor}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Correct Unit = <label f>{FinalObj.SUnit}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Amount = <label f>{FinalObj.SUnit * unitRs}</label>{" "}
        </div>
      </div>

      <div className="row ThirdMeter">
        <div className="col-2">Third Floor</div>
        <div className="col-2">
          <label for="inputPrefilledEx">Start Unit</label>
          <input
            name="TS"
        ...
        <div className="col-2">
          Consumption Unit = <label f>{FinalObj.ThirdFloor}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Correct Unit = <label f>{FinalObj.TUnit}</label>{" "}
        </div>
        <div className="col-2">
          {" "}
          Amount = <label f>{FinalObj.TUnit * unitRs}</label>{" "}
        </div>
      </div>
      ...
      <div className="calbutton row ">
        ...
        <div className="col-6">
          {" "}
          <label>
            Total Units: ( First Floor + Second Floor + Third Floor )={" "}
            {FinalObj.TotalSubMeter} Diffrence ={" "}
            {FinalObj.TotalSubMeter - MainMeter}{" "}
          </label>{" "}
        </div>
        <div className="col-2">
          <button
      ...
      <div className="row FinalRow">
        <div className="col-3">Final Units Bill Amount</div>
        <div className="col-3">Fst Floor - G.Floor = {FirstAmount}</div>
        <div className="col-3">Sec Floor - G.Floor = {SecondAmount}</div>
        <div className="col-3">Third Floor - G.Floor = {ThirdAmount} </div>
      </div>
    </div>
  );
};
